//
//  BitcoinAverageUSDFetcher.m
//  btcbar
//

#import "BitcoinAverageUSDFetcher.h"

@implementation BitcoinAverageUSDFetcher
...
- (id)init
{
    ...
    {
        // Menu Item Name
        self.ticker_menu = @"BitcoinAverageUSD";

        // Website location
        self.url = @"https://www.bitcoinaverage.com/";
...
- (void)requestUpdate
{
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://api.bitcoinaverage.com/ticker/global/USD/"]];

    // Set the request's user agent
    [request addValue:@"btcbar/2.0 (BitcoinAverageUSDFetcher)" forHTTPHeaderField:@"User-Agent"];
